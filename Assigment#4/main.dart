...
marksSheet() {
  ...
  double prcn = (total / 700) * 100;
  String prcnt=prcn.toStringAsFixed(2);
  String? status;
  String? grade;
  if (prcn >= 80) {
    grade = "A+";
    ...
    grade = "B";
    status = "Pass";
  } else if (prcn >= 50 && prcn < 60) {
    grade = "C";
    status = "Pass";
  } else if (prcn >= 40 && prcn < 50) {
    grade = "D";
    status = "Promoted";
  } else {
    grade = "Degrade";
...
// |   Total    :  $total     : 700     |
// |  -----------------------------  |  
// | | Status   :  Percent : Grade | |
// | |  $status    :  $prcnt%   : $grade    | |
// |---------------------------------|""");
var shet="""-------------Marks Sheet-----------
| | SUBJECT  : OBTAINED : TOTAL | |
| | NAME       MARKS      MARKS | |
|  -----------------------------  |          
|   Computer :  $comp      : 100     |      
